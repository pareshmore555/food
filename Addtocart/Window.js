      ...
      <View>
       ...
       <View style={styles.card}>
         <View style={styles.cardimagewraper}>
           <Image source={require("../assets/window.png")}resizeMode="cover" style={styles.cardimage}/>
         </View>
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Window Repair</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Window Assembly</Text>
