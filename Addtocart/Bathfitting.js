...
function Bathfitting({navigation}) {
    return (
      ...
      <View>
       ...
       <View style={styles.card}>
         <View style={styles.cardimagewraper}>
           <Image source={require("../assets/bathshower.png")}resizeMode="cover" style={styles.cardimage}/>
         </View>
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Bath Fitting Installation</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Shower Installtion</Text>
