...
function Homepainting({navigation}) {
    return (
      ...
      <View>
       ...
       <View style={styles.card}>
         <View style={styles.cardimagewraper}>
           <Image source={require("../assets/homepainting.png")}resizeMode="cover" style={styles.cardimage}/>
         </View>
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Home Painting Consultaion</Text>
           <Text>99 RS</Text>
