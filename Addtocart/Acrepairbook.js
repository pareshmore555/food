...
function Acrepairbook({navigation}) {
    return (
      ...
      <View>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Window Ac Repair</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Split Ac Repair</Text>
           <View style={{marginLeft:130}}> 
           <TouchableOpacity onPress={()=>{}}>
           <Button title="Book"  ></Button>
           </TouchableOpacity>
