...
function Carcleaning({navigation}) {
    return (
     <View style={styles.container}>
      ...
      <View style={styles.catagorycontainer}>
        ...
        <Text style={styles.catagorybuttontxt}>Hatchback</Text>
        </TouchableOpacity>
        ...
        <Text style={styles.catagorybuttontxt}>Compact SUV</Text>
        </TouchableOpacity>
        ...
        <Text style={styles.catagorybuttontxt}>SUV/MUV</Text>
        </TouchableOpacity> 
      </View>
      ...
      <View style={styles.catagorycontainer}>
        ...
        <Text style={styles.catagorybuttontxt}>Sedan</Text>
        </TouchableOpacity>
        ...
        <Text style={styles.catagorybuttontxt}>Luxury</Text>
        </TouchableOpacity>
