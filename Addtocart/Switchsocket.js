...
function Switchsocket({navigation}) {
    return (
      ...
      <View>
       ...
       <View style={styles.card}>
         <View style={styles.cardimagewraper}>
           <Image source={require("../assets/acswitchbox.jpg")}resizeMode="cover" style={styles.cardimage}/>
         </View>
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Ac switchBoard installation</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>SwitchBooard repair</Text>
           <View style={{marginLeft:130}}> 
           <TouchableOpacity onPress={()=>{}}>
           <Button title="Book"  ></Button>
           </TouchableOpacity>
