      ...
      <View>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Washbasin Repair</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Washbasin Installation</Text>
       ...
       <View style={styles.card}>
         ...
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>West Pipe</Text>
