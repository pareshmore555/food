...
function WoodPolishing({navigation}) {
    return (
      ...
      <View>
       ...
       <View style={styles.card}>
         <View style={styles.cardimagewraper}>
           <Image source={require("../assets/woodpolish.png")}resizeMode="cover" style={styles.cardimage}/>
         </View>
         <View style={styles.cardinfo}>
           <Text style={styles.cardtitle}>Wood Polish Consultaion</Text>
           <Text>99 RS</Text>
